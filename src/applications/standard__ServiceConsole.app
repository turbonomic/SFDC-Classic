...
<CustomApplication xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <workspaceConfig>
        <mappings>
            <tab>Enterprise_SE_Activity__c</tab>
        </mappings>
        <mappings>
            <tab>Finance_and_Legal_Docs__c</tab>
        </mappings>
        <mappings>
            <tab>Gsnap</tab>
        </mappings>
        <mappings>
            <tab>License_Features__c</tab>
        </mappings>
        <mappings>
            <tab>Partner_Event__c</tab>
        </mappings>
        <mappings>
            <tab>Partner_Office__c</tab>
        </mappings>
        <mappings>
            <tab>PhoneHome_Data__c</tab>
        </mappings>
        <mappings>
            <tab>SLA__c</tab>
        </mappings>
        <mappings>
            <tab>Talent_Management__c</tab>
        </mappings>
        <mappings>
            <tab>sma__MAFolder__c</tab>
        </mappings>
        <mappings>
